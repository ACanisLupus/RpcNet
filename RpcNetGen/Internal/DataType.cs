...
internal sealed class DataType
{
    public DataType(RpcParser.DataTypeContext dataType)
    {
        ...
        if (dataType.@bool() != null)
        {
            dataType.@bool().Check();
            Name = "Bool";
            Declaration = "bool";
        }
        else if (dataType.int8() != null)
        {
            dataType.int8().Check();
            Name = "Int8";
            Declaration = "sbyte";
        }
        else if (dataType.int16() != null)
        {
            dataType.int16().Check();
            Name = "Int16";
            Declaration = "short";
        }
        else if (dataType.int32() != null)
        {
            dataType.int32().Check();
            Name = "Int32";
            Declaration = "int";
        }
        else if (dataType.int64() != null)
        {
            dataType.int64().Check();
            Name = "Int64";
            Declaration = "long";
        }
        else if (dataType.uint8() != null)
        {
            dataType.uint8().Check();
            Name = "UInt8";
            Declaration = "byte";
        }
        else if (dataType.uint16() != null)
        {
            dataType.uint16().Check();
            Name = "UInt16";
            Declaration = "ushort";
        }
        else if (dataType.uint32() != null)
        {
            dataType.uint32().Check();
            Name = "UInt32";
            Declaration = "uint";
        }
        else if (dataType.uint64() != null)
        {
            dataType.uint64().Check();
            Name = "UInt64";
            Declaration = "ulong";
        }
        else if (dataType.float32() != null)
        {
            dataType.float32().Check();
            Name = "Float32";
            Declaration = "float";
        }
        else if (dataType.float64() != null)
        {
            dataType.float64().Check();
            Name = "Float64";
            Declaration = "double";
        }
        else if (dataType.Identifier() != null)
        {
